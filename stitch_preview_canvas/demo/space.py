...
```bash
pip install gradio_stitch_preview_canvas
```
...
""", elem_classes=["md-custom"], header_links=True)
    ...
    gr.ParamViewer(value=_docs["StitchPreviewCanvas"]["members"]["__init__"], linkify=[])


    gr.Markdown("### Events")
    gr.ParamViewer(value=_docs["StitchPreviewCanvas"]["events"], linkify=['Event'])
...
def predict(
    ...
    return value
```
""", elem_classes=["md-custom", "StitchPreviewCanvas-user-fn"], header_links=True)
