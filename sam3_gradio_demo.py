        ...
        with gr.Column(elem_classes="container"):
            ...
            with gr.Tabs(elem_id="main_tabs"):
                image_ui = build_image_tab(
                    ...
                    _layout_editor_empty=_layout_editor_empty,
                    _LAYOUT_PROMPT_SCOPE_FULL=_LAYOUT_PROMPT_SCOPE_FULL,
                    coco_dataset_choices=coco_dataset_choices,
                    default_coco_dataset=default_coco_dataset,
                    coco_eval_scope_overlap=coco_eval_scope_overlap,
                    coco_eval_scope_full=coco_eval_scope_full,
                )
                layout_ui = build_layout_mask_tab(
                    LayoutRegionAnnotator=LayoutRegionAnnotator,
                    _layout_region_annotator_import_error=_layout_region_annotator_import_error,
                    _layout_region_editor_empty=_layout_region_editor_empty,
                    _LAYOUT_MASK_MORPH_LIMIT_PX=_LAYOUT_MASK_MORPH_LIMIT_PX,
                )

            source_image_upload = image_ui.source_image_upload
            source_crop_overlay = image_ui.source_crop_overlay
            apply_crop_btn = image_ui.apply_crop_btn
            use_full_image_btn = image_ui.use_full_image_btn
            source_crop_status = image_ui.source_crop_status
            match_threshold = image_ui.match_threshold
            expand_threshold = image_ui.expand_threshold
            nms_threshold = image_ui.nms_threshold
            template_match_preview = image_ui.template_match_preview
            run_template_match_btn = image_ui.run_template_match_btn
            template_match_status = image_ui.template_match_status
            template_match_file = image_ui.template_match_file
            mode = image_ui.mode
            image_upload = image_ui.image_upload
            workspace_gesture_overlay = image_ui.workspace_gesture_overlay
            click_tool = image_ui.click_tool
            pcs_bbox_tools = image_ui.pcs_bbox_tools
            pcs_bbox_kind = image_ui.pcs_bbox_kind
            pcs_bbox_selector = image_ui.pcs_bbox_selector
            delete_selected_pcs_bbox_btn = image_ui.delete_selected_pcs_bbox_btn
            clear_prompt_btn = image_ui.clear_prompt_btn
            interaction_info = image_ui.interaction_info
            layout_point_refine_panel = image_ui.layout_point_refine_panel
            layout_point_kind = image_ui.layout_point_kind
            layout_point_btn = image_ui.layout_point_btn
            pcs_panel = image_ui.pcs_panel
            text_prompt = image_ui.text_prompt
            confidence_threshold = image_ui.confidence_threshold
            run_pcs_btn = image_ui.run_pcs_btn
            export_pcs_btn = image_ui.export_pcs_btn
            pcs_summary = image_ui.pcs_summary
            pvs_panel = image_ui.pvs_panel
            pvs_bbox_prompt_panel = image_ui.pvs_bbox_prompt_panel
            pvs_pending_count = image_ui.pvs_pending_count
            pvs_pending_bbox_selector = image_ui.pvs_pending_bbox_selector
            create_pvs_batch_btn = image_ui.create_pvs_batch_btn
            delete_selected_pending_bbox_btn = image_ui.delete_selected_pending_bbox_btn
            clear_pending_bbox_btn = image_ui.clear_pending_bbox_btn
            pvs_point_prompt_panel = image_ui.pvs_point_prompt_panel
            pvs_point_kind = image_ui.pvs_point_kind
            pvs_point_btn = image_ui.pvs_point_btn
            pvs_polygon_prompt_panel = image_ui.pvs_polygon_prompt_panel
            polygon_action = image_ui.polygon_action
            finish_polygon_btn = image_ui.finish_polygon_btn
            polygon_combine_mode = image_ui.polygon_combine_mode
            pvs_summary = image_ui.pvs_summary
            pvs_layout_panel = image_ui.pvs_layout_panel
            use_current_layout_btn = image_ui.use_current_layout_btn
            load_layout_binary_btn = image_ui.load_layout_binary_btn
            layout_prompt_mask_selector = image_ui.layout_prompt_mask_selector
            layout_binary_upload = image_ui.layout_binary_upload
            coco_dataset = image_ui.coco_dataset
            coco_image_name = image_ui.coco_image_name
            coco_split = image_ui.coco_split
            coco_eval_scope = image_ui.coco_eval_scope
            annotation_json_file = image_ui.annotation_json_file
            result_image = image_ui.result_image
            analysis_report_panel = image_ui.analysis_report_panel
            analysis_report = image_ui.analysis_report
            layout_transform_panel = image_ui.layout_transform_panel
            layout_editor = image_ui.layout_editor
            layout_enabled = image_ui.layout_enabled
            layout_tx = image_ui.layout_tx
            layout_ty = image_ui.layout_ty
            layout_scale = image_ui.layout_scale
            layout_rotation = image_ui.layout_rotation
            layout_alpha = image_ui.layout_alpha
            reset_layout_btn = image_ui.reset_layout_btn
            update_layout_preview_btn = image_ui.update_layout_preview_btn
            create_from_layout_btn = image_ui.create_from_layout_btn
            layout_pvs_info = image_ui.layout_pvs_info
            pvs_action_panel = image_ui.pvs_action_panel
            active_pvs = image_ui.active_pvs
            undo_pvs_btn = image_ui.undo_pvs_btn
            delete_pvs_btn = image_ui.delete_pvs_btn
            accept_pvs_btn = image_ui.accept_pvs_btn
            export_pvs_btn = image_ui.export_pvs_btn
            export_file = image_ui.export_file
            feedback_rating = image_ui.feedback_rating
            feedback_tags = image_ui.feedback_tags
            feedback_comment = image_ui.feedback_comment
            submit_feedback_btn = image_ui.submit_feedback_btn

            layout_input = layout_ui.layout_input
            layout_threshold = layout_ui.layout_threshold
            layout_invert = layout_ui.layout_invert
            layout_open_kernel = layout_ui.layout_open_kernel
            layout_close_kernel = layout_ui.layout_close_kernel
            layout_morph_pixels = layout_ui.layout_morph_pixels
            layout_min_area = layout_ui.layout_min_area
            layout_region_mode = layout_ui.layout_region_mode
            run_layout_mask_btn = layout_ui.run_layout_mask_btn
            save_layout_mask_btn = layout_ui.save_layout_mask_btn
            clear_layout_mask_btn = layout_ui.clear_layout_mask_btn
            layout_info = layout_ui.layout_info
            layout_mask_file = layout_ui.layout_mask_file
            layout_contour_file = layout_ui.layout_contour_file
            layout_source_preview = layout_ui.layout_source_preview
            layout_mask_preview = layout_ui.layout_mask_preview
            layout_overlay_preview = layout_ui.layout_overlay_preview
            layout_region_annotator = layout_ui.layout_region_annotator
            layout_region_label = layout_ui.layout_region_label
            save_layout_region_btn = layout_ui.save_layout_region_btn
            layout_region_selector = layout_ui.layout_region_selector
            delete_layout_region_btn = layout_ui.delete_layout_region_btn
            layout_region_status = layout_ui.layout_region_status
            export_layout_regions_btn = layout_ui.export_layout_regions_btn
            layout_region_export_file = layout_ui.layout_region_export_file
